function [lat,lon] = meshgratvec(map,maplegend,npts,units)

%MESHGRAT  Construct a graticule for a surface map object
%
% This function is a modification to the Mapping Toolbox's meshgrat. It
% returns only the vector values of latitude and longitude, rather than the
% full graticule.  
%
% Modified 2006 Kelly Kearney
%
